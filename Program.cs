    ...
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("Bài 1. Chương trình nhập số nguyên và kiểm tra xem số đó có chia hết cho 3 hay không\n\n" +
               "Bài 2. Chương trình Nhập vào số nguyên dương n, hiển thị bảng cửu chương từ 2 đến n ra màn hình\n\n"+
               "Bài 3.Chương trình Nhập vào số nguyên dương n, Tính tổng giai thừa từ 1 đến n và in ra màn hình\n\n"+
               "Bài 4. Chương trình Nhập vào số nguyên dương n, Kiểm tra xem n có phải là số chính phương và in ra màn hình\n\n"+
               "Bài 5. Chương trình cho biết số ngày trong tháng\n\n"+
               "Bài 6. Chương trình nhập vào số nguyên dương n, tính tổng S theo công thức sau 1+2^2+3^3+...n^n và hiển thị kquả ra màn hình\n\n"+
               "Bài 7. Chương trình nhập vào số nguyên dương n, tính tổng số lẻ từ 1 đến n và hiển thị kết quả ra màn hình\n\n"+
               "Bài 8. Nhập vào số nguyên dương n, Kiểm tra đó có phải là số nguyên tố hay không?\n\n"+
               "Bài 9. Chương trình nhập vào số hàng n, vẽ tam giác * với số hàng tương ứng\n\n"+
               "Bài 10. Chương trình Nhập vào số nguyên dương n, tính toán và hiển thị dãy Fibonacci ra màn hình\n");
            Console.Write("Mời bạn gõ số thứ tự bài tập: ");
            ...
            switch (stt)
            {
                ...
                case 2:
                    ...
                    Console.Write("Hãy nhập 1 số nguyên dương trong khoảng từ 2 đến 10: ");
                ...
                case 5:
                    ...
                    break;
                case 6:
                    Console.WriteLine("Bài 6. Chương trình nhập vào số nguyên dương n, tính tổng S theo công thức sau 1+2^2+3^3+...n^n và hiển thị k.quả ra màn hình");
